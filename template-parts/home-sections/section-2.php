...
?>
<?php 
if( get_theme_mod('theme_section_2_display_option', true )) :
	$section_title = get_theme_mod('theme_section_2_title', '');
	$section_title_type = get_theme_mod('theme_section_2_title_type', 'h2');
	$section_desc = get_theme_mod('theme_section_2_desc', '');

	$bgcolor = get_theme_mod('theme_section_2_background_color', '#fff');
	$top_padding = get_theme_mod('theme_section_2_top_padding', '0');
	$bottom_padding = get_theme_mod('theme_section_2_bottom_padding', '0');
    ...
    $blog_cat = get_theme_mod('theme_section_2_category') ;
    $posts_per_page = get_theme_mod('theme_section_2_post_count', 4);
    $posts_style = get_theme_mod('theme_section_2_post_style', 'list');
    $post_excerpt_length = get_theme_mod('theme_section_2_post_excerpt_length', 80);
