...
if( get_theme_mod('theme_section_4_display_option', true )) :
	...
	$section_title_type = get_theme_mod('theme_section_4_title_type', 'h2');
	$section_desc = get_theme_mod('theme_section_4_desc', '');

	$bgcolor = get_theme_mod('theme_section_4_background_color', '#fff');
	$top_padding = get_theme_mod('theme_section_4_top_padding', '0');
	$bottom_padding = get_theme_mod('theme_section_4_bottom_padding', '0');
    ...
    $posts_per_page = get_theme_mod('theme_section_4_post_count', 4);
    $posts_style = get_theme_mod('theme_section_4_post_style', 'list');
    $post_excerpt_length = get_theme_mod('theme_section_4_post_excerpt_length', 80);
