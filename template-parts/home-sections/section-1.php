...
if( get_theme_mod('theme_section_1_display_option', true )) :
    ...
    $posts_per_page = get_theme_mod('theme_section_1_post_count', 4);
    $posts_style = get_theme_mod('theme_section_1_post_style', 'list');
    $post_excerpt_length = get_theme_mod('theme_section_1_post_excerpt_length', 80);
