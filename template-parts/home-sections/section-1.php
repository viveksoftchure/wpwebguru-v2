...
if( get_theme_mod('theme_section_1_display_option', true )) :
	...
	$section_title_type = get_theme_mod('theme_section_1_title_type', 'h2');
	$section_desc = get_theme_mod('theme_section_1_desc', '');
	$circle_img = get_theme_mod('theme_section_1_img', '');

	$bgcolor = get_theme_mod('theme_section_1_background_color', '#fff');
	$top_padding = get_theme_mod('theme_section_1_top_padding', '0');
	$bottom_padding = get_theme_mod('theme_section_1_bottom_padding', '0');
	...
	?>
	<section class="home-cover-area <?= $item_class ?>">
	    <div class="container">
	        <div class="row home-cover-wrap has-cover-image">
	            <div class="col-lg-5">
	                <div class="cover-img-container">
	                    <div class="cover-img-wrap">
	                        <img  loading="lazy" src="<?= $circle_img ?>" alt="">
	            ...
	            <div class="col-lg-7">
	                <div class="home-cover-content-wrap">
	                    <<?= $section_title_type ?> class="heading-large"><?= $section_title ?></<?= $section_title_type ?>>
	                    <div class="intro-description"><?= $section_desc ?></div>
